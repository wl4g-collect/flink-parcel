...
git clone git@github.com:apache/flink-shaded.git
git checkout release-15.0 -C flink-shaded
vim flink-shaded/flink-shaded-zookeeper-parent/pom.xml # 修改 zookeeper 版本为 3.4.14
mvn clean install -B -DskipTests -Dfast -T4C

git clone git@github.com/apache/flink.git
git checkout release-1.15.2 -C flink
vim flink/pom.xml # 修改 zookeeper 版本为 3.4.14
